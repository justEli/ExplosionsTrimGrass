 ...
 */
public final class TrimEffectHandler implements Listener {
    ...
    @EventHandler
    void onExplosionTrimEvent(ExplosionTrimEvent event) {
        ...
        plugin.getScheduler().runLocationTaskLater(event.getLocation(), 1, () -> {
